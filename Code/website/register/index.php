  ...
  <body>
    <div class="container">
      ...
      <form class="form-signin rounded shadow" id="needs-validation" novalidate>
        ...
        <button type="button" class="btn btn-lg btn-primary btn-block" onclick="register(document.getElementById('inputFirstName').value, document.getElementById('inputLastName').value, document.getElementById('inputUsername').value, document.getElementById('inputEmail').value, document.getElementById('inputBirthdate').value, document.getElementById('inputPassword').checked)">Register</button>
